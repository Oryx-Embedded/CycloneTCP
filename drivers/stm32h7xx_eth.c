 ...
 * @brief STM32H743 Ethernet MAC controller
 *
 * @section License
 *
...
#include "stm32h7xx.h"
#include "core/net.h"
#include "drivers/stm32h7xx_eth.h"
#include "debug.h"
...
/**
 * @brief STM32H743 Ethernet MAC driver
 **/
...
/**
 * @brief STM32H743 Ethernet MAC initialization
...
/**
 * @brief STM32H743 Ethernet MAC timer handler
 *
...
/**
 * @brief STM32H743 Ethernet MAC interrupt service routine
 **/
...
/**
 * @brief STM32H743 Ethernet MAC event handler
 * @param[in] interface Underlying network interface
 **/
