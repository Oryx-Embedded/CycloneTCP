...
#define KSZ9893_SWITCH_MAC_CTRL1_JUMBO_PACKET_SUPPORT          0x04
#define KSZ9893_SWITCH_MAC_CTRL1_MAX_PACKET_SIZE_CHECK_DIS     0x02
#define KSZ9893_SWITCH_MAC_CTRL1_PASS_SHORT_PACKET             0x01
