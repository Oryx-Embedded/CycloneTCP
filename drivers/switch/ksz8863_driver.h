...
//KSZ8863 registers
#define KSZ8863_PHY_REG_BMCR        0x00
#define KSZ8863_PHY_REG_BMSR        0x01
#define KSZ8863_PHY_REG_PHYIDR1     0x02
#define KSZ8863_PHY_REG_PHYIDR2     0x03
#define KSZ8863_PHY_REG_ANAR        0x04
#define KSZ8863_PHY_REG_ANLPAR      0x05
#define KSZ8863_PHY_REG_LINKMDCS    0x1D
#define KSZ8863_PHY_REG_PHYSCS      0x1F
...
void ksz8863WritePhyReg(NetInterface *interface,
   uint8_t port, uint8_t address, uint16_t data);

uint16_t ksz8863ReadPhyReg(NetInterface *interface,
